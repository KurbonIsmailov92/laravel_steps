                                ...
                                <div class="flex items-center px-5">
                                    <div class="flex-shrink-0 items-center">
                                        <img class="h-10 w-10 rounded-full"
                                             src="https://avatars.githubusercontent.com/u/77341226?s=100&v=4"
                                             alt="">
                                    </div>
                                    <div class="ml-3">
                ...
                <div class="md:hidden" id="mobile-menu">
                    ...
                    <div class="border-t border-gray-700 pb-3 pt-4">
                        <div class="flex items-center px-5">
                            ...
                            <div class="ml-3">
                                <div class="text-base/5 font-medium text-white">Bon Ismailov</div>
                                <div class="text-sm font-medium text-gray-400">bon@example.com</div>
                            </div>
                            <button type="button"
